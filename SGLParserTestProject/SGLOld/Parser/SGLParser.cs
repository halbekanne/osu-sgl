// $ANTLR 3.2 Sep 23, 2009 12:02:23 D:\\sgl4c#\\NewSGLGramma\\SGL.g 2012-03-28 20:06:41
...
public partial class SGLParser : Parser
{
    ...
    // D:\\sgl4c#\\NewSGLGramma\\SGL.g:208:1: assignmentList : assignment ( ',' assignment )* ;
    ...
    {   
        ...
        try 
    	{
            ...
            // D:\\sgl4c#\\NewSGLGramma\\SGL.g:209:2: ( assignment ( ',' assignment )* )
            // D:\\sgl4c#\\NewSGLGramma\\SGL.g:209:4: assignment ( ',' assignment )*
            {
            	root_0 = (object)adaptor.GetNilNode();
            	...
            	// D:\\sgl4c#\\NewSGLGramma\\SGL.g:209:15: ( ',' assignment )*
            	do 
            	{
            	    int alt8 = 2;
            		...
            		{
            			case 1 :
            			    // D:\\sgl4c#\\NewSGLGramma\\SGL.g:209:16: ',' assignment
            			    {
    ...
    // D:\\sgl4c#\\NewSGLGramma\\SGL.g:213:1: globalAssignmentList : 'global' globalAssignment ( ',' globalAssignment )* ;
    ...
    {   
        ...
        try 
    	{
            ...
            // D:\\sgl4c#\\NewSGLGramma\\SGL.g:214:2: ( 'global' globalAssignment ( ',' globalAssignment )* )
            // D:\\sgl4c#\\NewSGLGramma\\SGL.g:214:4: 'global' globalAssignment ( ',' globalAssignment )*
            {
            	root_0 = (object)adaptor.GetNilNode();
            	...
            	// D:\\sgl4c#\\NewSGLGramma\\SGL.g:214:31: ( ',' globalAssignment )*
            	do 
            	{
            	    int alt9 = 2;
            		...
            		{
            			case 1 :
            			    // D:\\sgl4c#\\NewSGLGramma\\SGL.g:214:32: ',' globalAssignment
            			    {
    ...
    {   
        ...
        try 
    	{
            ...
            // D:\\sgl4c#\\NewSGLGramma\\SGL.g:230:4: variable ( indexes )? '.' Identifier '(' ( expressionList )? ')'
            {
            	...
            	// AST REWRITE
            	// elements:          variable, expressionList, indexes, Identifier
            	// token labels:      
            	// rule labels:       retval
            	// token list labels: 
            	// rule list labels:  
    ...
    {   
        ...
        try 
    	{
            ...
            // D:\\sgl4c#\\NewSGLGramma\\SGL.g:394:4: 'while' expression commonBlock
            {
            	...
            	// AST REWRITE
            	// elements:          85, commonBlock, expression
            	// token labels:      
            	// rule labels:       retval
            	// token list labels: 
            	// rule list labels:  
    ...
    {   
        ...
        try 
    	{
            ...
            // D:\\sgl4c#\\NewSGLGramma\\SGL.g:398:4: 'for' '(' (dec= oneLineStatement )? ';' (cond= expression )? ';' (iter= oneLineStatement )? ')' commonBlock
            {
            	...
            	// AST REWRITE
            	// elements:          dec, 86, commonBlock, cond, iter
            	// token labels:      
