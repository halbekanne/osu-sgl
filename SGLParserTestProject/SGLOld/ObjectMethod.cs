...
namespace SGLOld
{
    public class ObjectMethod
    {
        ...
        private Value sbObject;

        public ObjectMethod(String id, CommonTree identifiers, CommonTree block)
        {
            this.id = id;
        ...
        public ObjectMethod(ObjectMethod original)
        {
        ...
        public Value Invoke(Value sbObject, int offset, List<INode> parameters, Dictionary<String, Method> methods, Dictionary<String, ObjectMethod> objectMethods, StringBuilder sb, Scope globalScope, Random random)
        {
            ...
            // Now, we add some special variables, just for object methods
            scope.Assign("this", sbObject);
